...
base_path = 'emsr_rtc'
# Mount the "emsr_rtc" folder as a static folder

with open('emsr_rtc/flood_events.json', 'r') as f:
...
def get_flood_events(root='emsr_rtc', preview_pathname='preview_image'):
...
app.mount(f"/emsr_rtc", StaticFiles(directory=base_path), name=base_path)
